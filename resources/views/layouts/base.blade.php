...
<body class="home-page home-01 ">
                    ...
                    <div class="topbar-menu-area">
                        <div class="container">
                            <div class="topbar-menu left-menu">
                                <ul>
                                    <li class="menu-item" >
                                        <a title="Hotline: (+62) 87728433000" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+62) 87728433000</a>
                                    </li>
                                </ul>
                            </div>
    ...
    <script src="https://cdn.tiny.cloud/1/y2mdxjjdkdugyqjis480bap5avyhh3oq7ah0qjlgk0o6ntub/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
